    ...
    data() {
        return {
            bandiere: {
                ...
                ja: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Flag_of_Japan.svg/420px-Flag_of_Japan.svg.png',
                de: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Flag_of_Germany.svg/420px-Flag_of_Germany.svg.png',
            },
